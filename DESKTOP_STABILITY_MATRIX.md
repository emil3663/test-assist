...
| | Count |
|---|---|
| Cases in `DESKTOP_TEST_PLAN.md` v1.10 | 158 |
| Automated and passing | 152 |
| Blocked, documented as manual | 6 |
| Automated tests | 241 collected — 241 pass everywhere, no skips |
| Wall clock | about 2-3 seconds warm; the first run is slower while the bundled ffmpeg loads |

**A green run is `241 passed, 0 skipped`, everywhere.** MP4 assembly used to
...
QT_QPA_PLATFORM=offscreen pytest -q      # 241 passed, about 2-3 seconds warm;
